...
def main(args):
    ...
    #     label_list = ['None'] + reader.get_labels()
...
if __name__ == "__main__":
    ...
    args = [
        ...
        # '--data_dir=data/GLUE/QNLI/',
        # '--data_dir=data/GLUE/QQP/',
        # '--data_dir=data/GLUE/RTE/',
        # '--data_dir=data/GLUE/SST-2/',
        # '--data_dir=data/GLUE/STS-B/',
        '--data_dir=data/GLUE/WNLI/',
        # '--output_dir=out/GLUE/CoLA/',
        # '--output_dir=out/GLUE/MNLI/',
        # '--output_dir=out/GLUE/MRPC/',
        # '--output_dir=out/GLUE/QNLI/',
        # '--output_dir=out/GLUE/QQP/',
        # '--output_dir=out/GLUE/RTE/',
        # '--output_dir=out/GLUE/SST-2/',
        # '--output_dir=out/GLUE/STS-B/',
        '--output_dir=out/GLUE/WNLI/',
        '--model_type=bert',
        # '--model_name_or_path=sources/pretrained_bert/abci_bert_base_radam_256_sep_2/',
